...
export class ConfComponent implements OnInit {
  ...
  prte: Observable<Config> = this.confSrv.getOneByTag('PASSWORD_RESET_TOKEN_EXPIRATION');
  ...
  // privacyPolicies: Observable<Config> = this.confSrv.getOneByTag('PRIVACY_POLICIES');

  // cookiePolicies: Observable<Config> = this.confSrv.getOneByTag('COOKIE_POLICIES');
  ...
  updateConfiguration() {
    this.confSrv.updateOneByTag('PRIVACY_POLICIES', this.form.value.privacyPolicies).subscribe();
    this.confSrv.updateOneByTag('COOKIE_POLICIES', this.form.value.cookiePolicies).subscribe();
    this.confSrv.updateOneByTag('LEGAL_WARNING', this.form.value.legalWarning).subscribe();
  }
}
